...
pub enum IndexForAscTypeId {
    ...
    NeoNull = 123,
    NeoCustomGroups = 124,
    NeoCalledByEntry = 125,
    NeoCustomContracts =126,
    NeoArrayAccount = 127,
    NeoArrayCryptoHash = 128,
    NeoInteropInterface = 129,
    NeoMap = 130,
    NeoStruct = 131,
    NeoArray = 132,
    NeoBuffer = 133,
    ...
    NeoOnPersist = 148,
    NeoHighPriority=149,
    NeoOracleResponse = 150,
    NeoEnumOracleResponseCode = 151,
    NeoSuccess = 152,
    NeoProtocolNotSupported= 153,
    NeoConsensusUnreachable = 154,
    NeoNotFound = 155,
    NeoTimeout = 156,
    NeoResponseTooLarge =157,
    NeoInsufficientFunds = 158,
